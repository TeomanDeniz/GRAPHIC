/******************************************************************************\
# H - APP_LOOP__MACOS_OPENGL                     #       Maximum Tension       #
################################################################################
#                                                #      -__            __-     #
	...
	APP_LOOP(struct S_APP *APP)
{
	...
	while (!!APP->WINDOW_MODULE)
	{
       ...
       // Clear the color buffer
        ...
        glTexSubImage2D(GL_TEXTURE_2D, 0, 0, 0, APP->WIDTH, APP->HEIGHT, GL_RGBA, GL_UNSIGNED_BYTE, APP->BUFFER);
