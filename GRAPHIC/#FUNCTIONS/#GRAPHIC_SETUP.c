...
#	endif /* __STDC__ */
{
	...
	GRAPHIC->FPS = 60;
	GRAPHIC->WINDOW.BORDER = 1;
	GRAPHIC->WINDOW.TRANSPARENCY = 0;
	GRAPHIC->WINDOW.RESIZABLE = 1;
	GRAPHIC->WINDOW.MINIMIZABLE = 1;
	GRAPHIC->WINDOW.MAXIMIZABLE = 1;
	GRAPHIC->WINDOW.CLOSEBUTTON = 1;
	GRAPHIC->WINDOW.FOCUSABLE = 1;
	GRAPHIC->WINDOW.TOPMOST = 0;
	GRAPHIC->WINDOW.TOOLWINDOW = 0;
	GRAPHIC->WINDOW.HIDEONCREATE = 0;
	GRAPHIC->WINDOW.CLIENTEDGE = 0;
}
